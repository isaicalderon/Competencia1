...
public class ContactListAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        c_id.setText(contacto.getId());
        c_name.setText(contacto.getNombreCompleto());
        c_likes.setText(String.valueOf(contacto.getLikes()));
        c_comments.setText(String.valueOf(contacto.getComments()));
